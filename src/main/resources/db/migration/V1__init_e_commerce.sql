-- 1. Sequence (generatorlar) yaratish
...
-- 2. Birinchi navbatda MUSTAQIL jadvallarni yaratamiz
CREATE TABLE users (
...
-- 3. Endi ularga bog'lanadigan (BOLA) jadvallarni yaratamiz
CREATE TABLE orders (
                        id             BIGINT NOT NULL,
...
-- 4. Tashqi aloqalarni (Foreign Keys) bog'laymiz
ALTER TABLE orders
